const projects = [
    {
        ...
        techStack: ["React", "Node.js", "Express", "MongoDB", "REST API", "Tailwind CSS", "Material UI", "JWT", "Cloudinary", "Stripe", "Axios", "bcrypt", "cors", "dotenv", "multer"],
    ...
    },
    {
        id: "e-course",
        title: "E-Course Site",
        primaryStack: ["React", "Node.js", "Express", "MySQL"],
        techStack: ["React", "Node.js", "Express", "MySQL", "REST API", "Bootstrap", "JWT", "Axios", "bcrypt", "cors", "dotenv", "multer"],
    ...
    },
    {
        ...
        primaryStack: ["React", "Spring Boot", "MySQL"],
        techStack: [
            "React",
            "Spring Boot",
            "MySQL",
    ...
    },
    {
        ...
        primaryStack: ["React", "Bootstrap", "REST API"],
        techStack: ["React", "Bootstrap", "REST API", "Axios", "bcrypt", "cors"],
    ...
    },
    {
        ...
        primaryStack: ["HTML", "CSS", "JavaScript", "Bootstrap"],
        techStack: ["HTML5", "CSS3", "JavaScript", "Bootstrap 5", "Responsive Web Design", "Cross-Browser Compatibility"],
